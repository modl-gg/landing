...
const FAQData = [
  ...
  { question: "Can I customize the moderation rules for my game?", answer: "Absolutely! Everything is fully customizable. With smart & thought-out defaults, we let you tweak everything from locale messages to punishment types." },
  { question: "Can I migrate from LiteBans?", answer: "Yes! We offer migration tools to import all of your current punishments and player data from LiteBans." },
  { question: "Is modl.gg free to use?", answer: "Yes! Our platform is completely free to use, and it will stay this way. We provide a premium plan for extra features (targeted towards larger servers), but purchasing it is completely optional." },
  { question: "What Minecraft server types does modl.gg support?", answer: "We support Spigot, Paper, Folia, Velocity, and BungeeCord (forks too). Forge/Fabric support is being worked on right now." },
  { question: "Where can I report issues and/or give feedback?", answer: "You can email us or join our Discord at: modl.gg/discord" }
];
    ...
    <Accordion type="single" collapsible className="space-y-3">
      {items.map((faq, index) => (
        <AccordionItem
          ...
          className="border-b-0 card-surface overflow-hidden data-[state=open]:card-surface-active data-[state=open]:bg-[hsl(var(--surface-2))] transition-all"
        >
          <motion.div
          ...
          >
            <AccordionTrigger className="px-5 py-4 hover:no-underline hover:bg-white/[0.02] transition-colors">
              <span className="mr-2 flex-1 text-sm font-semibold text-left font-display leading-snug">
                {faq.question}
              </span>
            </AccordionTrigger>
